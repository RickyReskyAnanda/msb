        ...
        <div class="row">
            <div class="col s12 m12 l12">
                ...
                <div class="card-panel">
                    <div class="row">
                        <form class="col s12 formValidate" id="formdistrik" method="post" action="{{url('administrator/data-master/distrik/tambah')}}">
                            {{csrf_field()}}
                            <div class="row">
                                <div class="input-field col s12">
                                    <label for="nm_distrik">Nama Distrik</label>
                                    <input type="text" name="nm_distrik" id="nm_distrik" data-error=".errorTxt1">
