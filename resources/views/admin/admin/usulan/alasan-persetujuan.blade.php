    ...
    <div class="container">
        <div class="row">
            <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Alasan {{ucfirst($persetujuan)}}</h5>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="section">
        ...
        <div class="row">
            <div class="col s12 m12 l12">
                ...
                @endif
                <form class="formValidate" id="formalasan" method="post" action="{{url('administrator/usulan/persetujuan')}}">
                    {{csrf_field()}}
                    <input type="hidden" name="id_usul_bappeda" value="{{$id}}">
