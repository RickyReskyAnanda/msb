        ...
        <div class="row">
            <div class="col s12 m12 l12">
                ...
                <ol class="breadcrumbs">
                    ...
                    <li><a href="{{url('administrator/usulan')}}">Usulan</a></li>
                    <li class="active">Edit Usulan Masuk</li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <div class="section">
        ...
        <div class="row">
            <div class="col s12 m12 l12">
                ...
                @endif
                <form class="col s12 formValidate" id="editusulan" method="post" action="{{url('administrator/usulan/edit')}}" enctype="multipart/form-data">
                    <div class="card">
                        <div class="card-content">
                            <div class="card-content">
                                <span class="card-title">Kampung {{ucwords($detail->desa->nm_desa)}}</span><br>
                            ...
                            <div class="row">
                                <div class="col s12">
                                    ...
                                    <select class="error browser-default" id="jalan" name="jalan" data-error=".errorTxt2">
                                        ...
                                        @foreach($detail->desa->jalan as $jln)
                                ...
                                <div class="col s3">
                                    <div class="card">
                                        ...
                                        <div class="card-action">
                                            <a href="{{url('administrator/usulan/edit/hapus-gambar/'.$ft->id_foto)}}" class="red-text"><i class="mdi-navigation-close small"></i>Hapus</a>
                                        </div>
                                    </div>
                                </div>
                                @endforeach
