            ...
            <div class="col s12">
                ...
                <div class="card">
                    <div class="card-content">
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <div class="card amber lighten-3">
                                                    <div class="card-content">
                                                        <b>Kampung: </b><br>
                                                        <?php if(isset($val->usulanDesa->desa->nm_desa))echo $val->usulanDesa->desa->nm_desa; ?>
                                                    </div>
                                                </div>
                                                <div class="card amber lighten-3">
                                                    <div class="card-content">
                                                        <b>Distrik: </b><br>
                                                        <?php if(isset($val->distrik->nm_distrik))echo $val->distrik->nm_distrik; ?>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                        ...
                        @if((!isset($request->desa) && !isset($request->tipe)) || ($request->desa==0 && $request->tipe==0) )
