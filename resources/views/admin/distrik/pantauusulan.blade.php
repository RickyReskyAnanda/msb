                                ...
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="teal lighten-4 center" colspan="3">{{$usul->nama_pekerjaan}}</td>
                                        </tr>
                                        <tr>
                                            <th class="blue lighten-3">Keterangan</th>
                                            <td class="blue lighten-4">{{$usul->usulanDesa->keterangan}}</td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="yellow lighten-4">
                                                {{$usul->usulanDesa->volume.' X '.number_format($usul->usulanDesa->harga).' /'.$usul->usulanDesa->satuan}}<br>
                                                <b>Hasil : </b> Rp.<?=number_format($usul->usulanDesa->volume*$usul->usulanDesa->harga)?>
                                            </td>
                                            <td class="yellow lighten-4">
                                        ...
                                        <tr>
                                            ...
                                            <td class="deep-orange lighten-4">{{$usul->usulanDesa->sts_usulan}}</td>
